...
public class CouponChangerCheat : ICheat
{
    ...
    private static long pointsRequiredFromTicketCount(int tickets) =>
        ...
        tickets < 4 ? 1000 : (long)(Pow(Ceiling(tickets / 3.0), 2) * 1000);
    ...
    public bool Apply(SaveObjectModel rootItem, SatisfactorySave saveGame)
    {
        ...
        try
        {
            ...
            var calculatedPointsCount = pointsRequiredFromTicketCount(requestedTicketCount);
