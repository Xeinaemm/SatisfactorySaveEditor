...
public class RevealMapCheat : ICheat
{
    ...
    public bool Apply(SaveObjectModel rootItem, SatisfactorySave saveGame)
    {
        ...
        if (fogOfWarRawData is not ArrayPropertyViewModel)
        {
        ...
        try
        {
            ...
            if (mapRevealThreshold is >= 0 and <= 255)
            {
                for (var i = 0; i < fogOfWarRawData.Elements.Count; i++)
                {
