...
public class BinaryIOTests
{
    ...
    private static readonly byte[] PersistentLevelStringBytes = [0x11, 0x00, 0x00, 0x00, 0x50, 0x65, 0x72, 0x73, 0x69, 0x73, 0x74, 0x65, 0x6E, 0x74, 0x5F, 0x4C, 0x65, 0x76, 0x65, 0x6C, 0x00];
    private static readonly string UnicodeTestString = "unicodetestöäßµ";
    private static readonly byte[] UnicodeTestStringBytes = [0xF0, 0xFF, 0xFF, 0xFF, 0x75, 0x00, 0x6E, 0x00, 0x69, 0x00, 0x63, 0x00, 0x6F, 0x00, 0x64, 0x00, 0x65, 0x00, 0x74, 0x00, 0x65, 0x00, 0x73, 0x00, 0x74, 0x00, 0xF6, 0x00, 0xE4, 0x00, 0xDF, 0x00, 0xB5, 0x00, 0x00, 0x00];
    private static readonly string EmptyString = "";
    private static readonly byte[] EmptyStringBytes = [0x00, 0x00, 0x00, 0x00];
    ...
    [TestMethod]
    public void TestSerializedASCIILength() => Assert.AreEqual(PersistentLevelStringBytes.Length, PersistentLevelString.GetSerializedLength());
    ...
    [TestMethod]
    public void TestSerializedUnicodeLength() => Assert.AreEqual(UnicodeTestStringBytes.Length, UnicodeTestString.GetSerializedLength());
