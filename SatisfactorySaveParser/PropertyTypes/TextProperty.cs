...
public class TextProperty(string propertyName, int index = 0) : SerializedProperty(propertyName, index)
{
    ...
    public override string ToString() => $"Text {PropertyName}: {Text}";
    ...
    private static void UpdateTextEntry(TextEntry entry, int buildVersion)
    {
            ...
            case ETextHistoryType.Transform:
                {
                    ...
                    {
                        SourceText = ParseTextEntry(reader, buildVersion),
