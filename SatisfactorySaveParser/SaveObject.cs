...
public abstract class SaveObject
{
    ...
    public virtual void SerializeData(BinaryWriter writer, int buildVersion) => DataFields.Serialize(writer, buildVersion);

    public virtual void ParseData(int length, BinaryReader reader, int buildVersion) => DataFields = SerializedFields.Parse(length, reader, buildVersion);

    public override string ToString() => TypePath;
}
